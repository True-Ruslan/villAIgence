#!/usr/bin/env python3
"""Add explicit 0.3.x patch-release semantics on top of the frozen 0.3.0 validator."""
...
import release_convergence as baseline
...
def _validate_frozen_candidate(contract: Mapping[str, Any], root: Path) -> tuple[str, ...]:
    """Run the original validator against the real tree with only NEXT_RELEASE rewound to 0.3.0."""
